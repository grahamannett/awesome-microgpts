...
| [micro-attention-residuals](https://github.com/grahamannett/micro-attention-residuals) | [@grahamannett](https://github.com/grahamannett) | A micro GPT implementation with Block Attention Residuals from MoonshotAI, extending microgpt with learned residual-memory mixing before each sublayer. | 
